...
const MixedMediaExperiments: React.FC = () => {
  ...
  const projectData = {
    ...
    details: {
      ...
      materials: 'Acrylic, digital prints, collage elements',
      techniques: 'Layering, digital manipulation, physical assembly'
    }
  };
            ...
            <div className="sticky top-20">
              ...
              <div className="space-y-4 text-sm">
                ...
                <div>
                  ...
                  <br />
                  {projectData.details.materials}
                </div>
                <div>
                  <span className="font-medium">Techniques:</span>
                  <br />
                  {projectData.details.techniques}
                </div>
              </div>
            </div>
          </motion.div>
...
export default MixedMediaExperiments;